...
void selectionSort(int *array, int size, bool (*fncCompare)(int, int) )
{
    ...
    for (int startIndex = 0; startIndex < size; ++startIndex)
    {
        ...
        for (int currentIndex = startIndex + 1; currentIndex < size; ++currentIndex)
        {
            ...
            if (fncCompare(array[bestIndex], array[currentIndex]) ) // COMPARISON DONE HERE
...
{
	//This function sorts the array so that the following value is at most 2 higher than the trailing value
    return x < y - 2;
}
...
int main()
{
	...
	cout << "*      CS1C 3/24/2020 5:00 PM        * " << endl;
	cout << "************************************** " << endl;
	cout << endl;
	...
	//fcnPtr1 = &boo; Doesn't work because fcnPtr1 is has a string return type
...
// Although dPtr is a Base class pointer to a D2 object, D2::function2() is called because it
// is the most derived funciton available to a D2 object.

// Q#5

// The slicing problem occurs when a derived class object is assigned to a base class object.
// The extra value derived_id of the class DerivedSlice is lost when baseSlice is set to a
// BaseSlice object of dSlice.
// baseSlice will not contain a derived_id value
